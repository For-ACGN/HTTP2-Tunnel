...
// Any files in the ui/dist folder will be embedded into the binary and
...
func main() {
	...
	// 'Bind' is a list of Go struct instances. The ui has access to the methods of these instances.
	...
	// The ui can listen to this event and update the UI accordingly.
	go func() {
		for {
